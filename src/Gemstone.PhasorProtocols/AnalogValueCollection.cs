...
{
    /// <summary>
    /// Represents a protocol independent collection of <see cref="IAnalogValue"/> objects.
    /// </summary>
    [Serializable]
    public class AnalogValueCollection : ChannelValueCollectionBase<IAnalogDefinition, IAnalogValue>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="AnalogValueCollection"/> using specified <paramref name="lastValidIndex"/>.
        /// </summary>
        ...
        /// </remarks>
        public AnalogValueCollection(int lastValidIndex)
            : base(lastValidIndex)
        {
        }

        /// <summary>
        /// Creates a new <see cref="AnalogValueCollection"/> from serialization parameters.
        /// </summary>
