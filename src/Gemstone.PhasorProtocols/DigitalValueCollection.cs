//******************************************************************************************************
//  DigitalValueCollection.cs - Gbtc
//
...
{
    /// <summary>
    /// Represents a protocol independent collection of <see cref="IDigitalValue"/> objects.
    /// </summary>
    [Serializable]
    public class DigitalValueCollection : ChannelValueCollectionBase<IDigitalDefinition, IDigitalValue>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="DigitalValueCollection"/> using specified <paramref name="lastValidIndex"/>.
        /// </summary>
        ...
        /// </remarks>
        public DigitalValueCollection(int lastValidIndex)
            : base(lastValidIndex)
        {
        }

        /// <summary>
        /// Creates a new <see cref="DigitalValueCollection"/> from serialization parameters.
        /// </summary>
