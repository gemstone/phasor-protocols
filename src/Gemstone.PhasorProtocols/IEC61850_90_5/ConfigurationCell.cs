...
namespace Gemstone.PhasorProtocols.IEC61850_90_5
{
    ...
    public class ConfigurationCell : ConfigurationCellBase
    {
        ...
        // Fields - setting defaults to floating point / polar for IEC 61850-90-5
        private FormatFlags m_formatFlags = FormatFlags.Phasors | FormatFlags.Coordinates | FormatFlags.Analog | FormatFlags.Frequency;
        ...
        {
            // IEC 61850-90-5 always uses floating point values
        ...
        {
            // IEC 61850-90-5 always uses polar phasor values
            get => CoordinateFormat.Polar;
            set { }
        }

        /// <summary>
        /// Gets or sets the <see cref="AngleFormat"/> for the <see cref="IPhasorDefinition"/> objects in the <see cref="ConfigurationCellBase.PhasorDefinitions"/> of this <see cref="ConfigurationCell"/>.
        /// </summary>
        public override AngleFormat PhasorAngleFormat
        {
            // User can control angle parsing format through connection parameter
            get => Parent.CommonHeader.PhasorAngleFormat;
            set { }
        }
