//******************************************************************************************************
//  DigitalDefinitionCollection.cs - Gbtc
//
...
{
    /// <summary>
    /// Represents a protocol independent collection of <see cref="IDigitalDefinition"/> objects.
    /// </summary>
    [Serializable]
    public class DigitalDefinitionCollection : ChannelDefinitionCollectionBase<IDigitalDefinition>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="DigitalDefinitionCollection"/> from serialization parameters.
        /// </summary>
        /// <param name="info">The <see cref="SerializationInfo"/> with populated with data.</param>
        /// <param name="context">The source <see cref="StreamingContext"/> for this deserialization.</param>
        protected DigitalDefinitionCollection(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
