...
{
    /// <summary>
    /// Represents a protocol independent collection of <see cref="IDataFrame"/> objects.
    /// </summary>
    [Serializable]
    public class DataFrameCollection : ChannelFrameCollectionBase<IDataFrame>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="DataFrameCollection"/> using specified <paramref name="lastValidIndex"/>.
        /// </summary>
        ...
        /// </remarks>
        public DataFrameCollection(int lastValidIndex)
            : base(lastValidIndex)
        {
        }

        /// <summary>
        /// Creates a new <see cref="DataFrameCollection"/> from serialization parameters.
        /// </summary>
