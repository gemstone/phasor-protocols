...
/// <summary>
/// Represents the SEL CWS implementation of a <see cref="IPhasorDefinition"/>.
/// </summary>
[Serializable]
public class PhasorDefinition : PhasorDefinitionBase
{
    ...
    public PhasorDefinition(ConfigurationCell parent, string label, PhasorType type)
        : base(parent, label, 1, 0.0D, type, null)
    {
    }
